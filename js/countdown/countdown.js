...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2014/06/17 00:00:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">Time is up! We can start to be scared...</span></span>');
 timer.countDown();
}
